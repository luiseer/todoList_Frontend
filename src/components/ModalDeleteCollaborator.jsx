...
const ModalDeleteCollaborator = () => {
  ...
  return (
    <Transition.Root show={modalDeleteCollaborator} as={Fragment}>
      <Dialog as="div" className="fixed z-50 inset-0 overflow-y-auto" onClose={handleModalDeleteCollaborator}>
            ...
            <div className="inline-block align-bottom bg-white rounded-2xl px-6 pt-6 pb-6 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-8">
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-slate-500">The removed collaborator will no longer have access to this project.</p>
                  </div>
                </div>
              </div>
              <div className="mt-6 sm:flex sm:flex-row-reverse gap-3">
                <button type="button" className="btn-danger w-full sm:w-auto" onClick={deleteCollaborator}>
                  Remove
                </button>
                <button type="button" className="btn-secondary w-full sm:w-auto mt-3 sm:mt-0" onClick={handleModalDeleteCollaborator}>
                  Cancel
                </button>
              </div>
            </div>
